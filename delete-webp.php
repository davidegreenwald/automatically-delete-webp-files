 ...
 */
 ...
 function adwf_delete_webp_with_original_image( $attachmentid ) {
 	...
 	if( isset( $attachmentid ) ) {
		...
		// set the image pattern for regex use
		$img_formats = '/\.(jp(e)?g|png|gif)/';
 		//get the file path without the .jpg, .png, or .gif extension
 		$img_root = preg_replace( $img_formats, '', $img );
		...
		preg_match( $img_formats, $img, $img_matches);
